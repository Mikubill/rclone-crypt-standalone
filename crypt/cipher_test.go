...
func TestNewEncrypterErrUnexpectedEOF(t *testing.T) {
	...
	in := &ErrorReader{Err: io.ErrUnexpectedEOF}
...
func TestNewDecrypter(t *testing.T) {
	...
	er := &ErrorReader{Err: errors.New("potato")}
...
func TestNewDecrypterErrUnexpectedEOF(t *testing.T) {
	...
	in2 := &ErrorReader{Err: io.ErrUnexpectedEOF}
...
func TestDecrypterRead(t *testing.T) {
	...
	in2 := &ErrorReader{Err: errors.New("potato")}
